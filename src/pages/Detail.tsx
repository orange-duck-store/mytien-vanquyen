...
{isDisplaySpinner && <SpinningText className='absolute top-32 right-8 z-50 block sm:hidden'>learn more • earn more • grow more •</SpinningText>}
 <SparklesText className='my-3 mt-5 text-center text-[#495F88]' text="Chà để hiển thị" />;
    ...
    >
      <p className="text-sm leading-8 p-1"> Không ai trong chúng ta biết được khi nào mới là lần cuối, vậy nên hãy luôn tôn trọng nhau như thể đó là lần cuối. Hãy biết ơn mỗi lần được gặp nhau, giống như cách chúng ta đã từng biết ơn duyên phận đã tác thành cho mối lương duyên ấy.
</p>
    </ScratchToReveal>
  </div>
 </div>
